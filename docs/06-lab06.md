...
Where do pipes send the result of the function that precedes the pipe? <select class='solveme' data-answer='["To the first argument of the next function."]'> <option></option> <option>To the third argument of the 18th function.</option> <option>To the first argument of the next function.</option> <option>To the last argument of the next function.</option> <option>To Ibiza.</option></select>
