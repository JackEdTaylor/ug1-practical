...
* Which of the following is most likely to be an argument? <select class='solveme' data-answer='["35"]'> <option></option> <option><-</option> <option>35</option> <option>read_csv()</option></select>

* An easy way to spot functions is to look for <select class='solveme' data-answer='["brackets"]'> <option></option> <option>computers</option> <option>brackets</option> <option>numbers</option></select>.

* The job of `<-` is to send the output from the function to a/an <select class='solveme' data-answer='["variable"]'> <option></option> <option>argument</option> <option>variable</option> <option>assignment</option></select>.
