...
* In a normal distribution, the mean, median, and mode `r mcq(sample(c(answer = "are all equal", "sum to zero", "are always interval data")))`.
* An example of data in which you might expect to see a normal distribution is `r mcq(sample(c(answer = "the number of goals scored by Leeds United F.C.", "the number of heads observed out of 10 coin flips", "the number of people who are right handed")))`.
